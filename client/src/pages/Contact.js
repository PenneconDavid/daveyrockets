      ...
      >
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            <label
              htmlFor="first-name"
              className="block text-sm font-semibold leading-6 text-bg-lime-700"
            >
              First name
            </label>
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-md border-0 px-3.5 py-2 text-bg-lime-900 shadow-sm ring-1 ring-inset ring-bg-lime-300 placeholder:text-bg-lime-400 focus:ring-2 focus:ring-inset focus:ring-bg-lime-600 sm:text-sm sm:leading-6"
                value={firstName}
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-gradient-to-r from-[#EFBD19] to-[#8000FF] px-3.5 py-2.5 text-center text-sm font-semibold text-[#f3eacc] shadow-sm hover:bg-bg-lime-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-bg-lime-600"
          >
            Leave me a message
          </button>
        </div>
